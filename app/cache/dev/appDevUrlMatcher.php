...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/athletes')) {
            // athletes_index
            if (rtrim($pathinfo, '/') === '/athletes') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_athletes_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'athletes_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\AthletesController::indexAction',  '_route' => 'athletes_index',);
            }
            not_athletes_index:

            // athletes_new
            if ($pathinfo === '/athletes/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_athletes_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\AthletesController::newAction',  '_route' => 'athletes_new',);
            }
            not_athletes_new:

            // athletes_show
            if (preg_match('#^/athletes/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_athletes_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'athletes_show')), array (  '_controller' => 'AppBundle\\Controller\\AthletesController::showAction',));
            }
            not_athletes_show:

            // athletes_edit
            if (preg_match('#^/athletes/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_athletes_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'athletes_edit')), array (  '_controller' => 'AppBundle\\Controller\\AthletesController::editAction',));
            }
            not_athletes_edit:
            ...
            if (preg_match('#^/athletes/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_athletes_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'athletes_delete')), array (  '_controller' => 'AppBundle\\Controller\\AthletesController::deleteAction',));
            }
            not_athletes_delete:

        }

        if (0 === strpos($pathinfo, '/epreuves')) {
            // epreuves_index
            if (rtrim($pathinfo, '/') === '/epreuves') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'epreuves_index');
                }
        ...
        // epreuves
        if (0 === strpos($pathinfo, '/epreuves') && preg_match('#^/epreuves/(?P<idepreuves>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'epreuves')), array (  '_controller' => 'AppBundle\\Controller\\EpreuvesController::showAction',));
        }
